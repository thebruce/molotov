...
test('validateMolotovSettings', async (t) => {
  const molotovProviderBase = new MolotovProviderBase('./test/helpers/');
...
test('molotovConfigDoesntExist', (t) => {
  const molotovProviderBase = new MolotovProviderBase('./test/helpers/baba');
  t.throws(
...
test('validateMolotovSettingsFalse', async (t) => {
  const molotovProviderBase = new MolotovProviderBase('./test/helpers/fakeMolotovOne');
  t.context.data = await molotovProviderBase.validateMolotovSettings('supersNameSpacePaths');
...
test('validateMolotovSettingsFalseAgain', async (t) => {
  const molotovProviderBase = new MolotovProviderBase('./test/helpers/fakeMolotovTwo');
  t.context.data = await molotovProviderBase.validateMolotovSettings('supersNameSpacePaths');
  t.false(t.context.data);
});
